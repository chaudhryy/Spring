...
import nz.co.spark.intg.ocp.utility.ocp.db.dao.ModuleStatDao;
...
import nz.co.spark.intg.ocp.utility.provider.ocp.json.dclist.*;
...
//                                    }
    ...
    private String getcmFromCMList(String module_name, CMSuccessResponse cmResponse) {
       if(cmResponse != null && !CollectionUtils.isEmpty(cmResponse.getItems())){
           for(nz.co.spark.intg.ocp.utility.provider.ocp.json.CMlist.Item item : cmResponse.getItems()){
