...
public class Parameter_ {
    ...
    public Parameter_ withIn(String in) {
        this.in = in;
        return this;
    }
    ...
    public Parameter_ withDescription(String description) {
        this.description = description;
        return this;
    }
    ...
    public Parameter_ withRequired(Boolean required) {
        this.required = required;
        return this;
    }
    ...
    public Parameter_ withType(String type) {
        this.type = type;
        return this;
    }
    ...
    public Parameter_ withXExample(String xExample) {
        this.xExample = xExample;
        return this;
    }
