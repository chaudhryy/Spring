package nz.co.spark.intg.ocp.utility.beans;

import nz.co.spark.intg.ocp.utility.cache.LocalCache;
import nz.co.spark.intg.ocp.utility.exceptions.OcpException;
import nz.co.spark.intg.ocp.utility.provider.ocp.json.CMlist.CMSuccessResponse;
import nz.co.spark.intg.ocp.utility.provider.ocp.json.dclist.DcSuccessResponse;
import nz.co.spark.intg.ocp.utility.provider.ocp.json.podlists.PodListSuccessResponse;
import nz.co.spark.intg.ocp.utility.provider.ocp.json.projectlist.ProjectResponseList;
import nz.co.spark.intg.ocp.utility.provider.ocp.json.routelist.RouteListSuccessResponse;
import nz.co.spark.intg.ocp.utility.provider.ocp.json.secretlist.SecretSuccessResponse;
